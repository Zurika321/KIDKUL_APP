...
import 'package:KulBlock/widgets/2IOT&Control/phantu/Chart/WidgetChart.dart';
...
class _CustomChartStates extends State<CustomChart> {
  ...
  void _showEditDialog() {
    final titleController = TextEditingController(
      text: widget.config['title'] ?? 'Chart',
    );
    ...
    final dropdowns = [
      ...
      DropdownInputField<String>(
        ...
        items_name: Data.isNotEmpty ? ['None', ...Data.keys] : [],
  ...
  Widget build(BuildContext context) {
    final chartTitle = widget.config['title'] ?? 'Chart';
