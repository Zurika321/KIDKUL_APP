...
import 'package:KulBlock/widgets/4Home/ButtonHomeScreen.dart';

//get page - lấy trang
import 'package:KulBlock/widgets/5Setting/settingScreen.dart';
import 'package:KulBlock/widgets/1Menu/Menus.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final List<ButtonHomeScreenConfig> buttonConfigs = [
      ButtonHomeScreenConfig(
        ...
        navigator: Menus(menu: "Menu Control"),
        color: const Color.fromARGB(247, 164, 217, 255),
      ),
      ButtonHomeScreenConfig(
        icon: Icons.code,
        ...
        navigator: Menus(menu: "Menu Prograning"),
        color: const Color.fromARGB(255, 255, 221, 136),
      ),
      ButtonHomeScreenConfig(
        icon: Icons.devices,
        title: AppLocalizations.of(context)!.iot,
        imgPath: 'lib/assets/images/iot.png',
        navigator: Menus(menu: "Menu IOT"),
        color: const Color.fromARGB(255, 129, 218, 129),
      ),
      // ButtonHomeScreenConfig(
      //   icon: Icons.settings,
      //   title: AppLocalizations.of(context)!.setting,
      //   imgPath: 'lib/assets/images/setting.png',
      //   navigator: const SettingScreen(),
