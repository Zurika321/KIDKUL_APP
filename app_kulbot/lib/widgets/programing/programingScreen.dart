...
class _ProgramingscreenState extends State<Programingscreen> {
  ...
  final BlocklyOptions workspaceConfiguration = BlocklyOptions.fromJson(const {
    'grid': {'spacing': 12, 'length': 30, 'colour': '#b6b6b6', 'snap': true},
              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    child: Column(
                      children:
                          blocklyItems.asMap().entries.map((entry) {
                            int index = entry.key;
    ...
    try {
      addons.add(
        await rootBundle.loadString(
          'assets/scratch/blocks/events_generators.js',
        ),
      );
      addons.add(
        await rootBundle.loadString('assets/scratch/blocks/module.js'),
      );
      addons.add(
        await rootBundle.loadString('assets/scratch/blocks/display.js'),
      );
      addons.add(
        await rootBundle.loadString('assets/scratch/blocks/motions.js'),
      );
