...
class _UploadDialogState extends State<_UploadDialog> {
  ...
  Future<void> _setupAndUpload() async {
    try {
      ...
      if (isUploading) {
        setState(() => log.add("❌ Lỗi trong setup: $e"));
      }
    }
  }
  ...
  Future<void> _uploadCode(String code) async {
    ...
    for (final line in lines) {
      ...
      setState(() => log.add("📤 bên app báo: $finalLine"));
    ...
    setState(() => log.add("📤 bên app báo: crc:$crcHex"));
    await writeLong(utf8.encode("crc:$crcHex\n"));

    setState(() {
      log.add("📤 bên app báo: done");
      isUploading = false;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: const Text("Đang upload code..."),
      content: SizedBox(
