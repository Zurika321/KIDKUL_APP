...
//   bool switch1 = false;
//   bool switch2 = false;
//   final Color _containerColor_1 = Colors.blue;
//   final Color _containerColor_2 = Colors.blue;
...
//   final double _currentValueId1 = 0.0;
//   final double _currentValueId2 = 0.0;
//   final double _currentValueId3 = 0.0;
//   final double _currentValueId4 = 0.0;
...
//   void initState() {
//     super.initState();
//     stream = const Stream.empty(); // This will ensure stream is not null
//     _loadSettings();
...
//                   context,
//                   MaterialPageRoute(
//                     builder: (context) => const SettingiotWidget(),
//                   ),
//                 ).then((_) {
...
//                                   : Colors.red,
//                         )
//                         : const Icon(Icons.bluetooth, color: Colors.red),
//                 onPressed: () {
...
//               : stream == null
//               ? const Center(
//                 child: Text('Chưa kết nối với thiết bị Bluetooth.'),
//               )
